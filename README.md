...
## [Demo](http://rawgit.com/start-javascript/ejm-app/master/dist/)
...
`ejm-app` provides the following features:
...
```bash
$ git clone https://github.com/start-javascript/ejm-app.git
$ cd ejm-app
