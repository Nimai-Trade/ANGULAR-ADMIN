...
@Component({
  selector: 'app-transaction-quotes',
  templateUrl: './transaction-quotes.component.html',
  styleUrls: ['./transaction-quotes.component.scss']
})
export class TransactionQuotesComponent implements OnInit {
  ...
  onPreview(id) {
    console.log('>>>> ' + id);
    const dialogRef = this.dialog.open(QuotesDetailsComponent, {
      width: '50%',
      height: '100%',
