...
@Component({
  selector: 'app-secondary-transaction-list',
  templateUrl: './secondary-transaction-list.component.html',
  styleUrls: ['./secondary-transaction-list.component.scss'],
  providers: [
    {
      provide: MAT_DATE_FORMATS, useValue: APP_DATE_FORMATS
    }]
})
export class SecondaryTransactionListComponent implements OnInit {
  ...
  onPreview(id) {
  // console.log('>>>> ' + id);
    const dialogRef = this.dialog.open(SecondaryTransactionDetailsComponent, {
      width: '50%',
      height: '100%',
